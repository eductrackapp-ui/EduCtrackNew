...
public class AdminProfileActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnDeleteAccount = findViewById(R.id.btnDeleteAccount); // ⚡ ajoute ce bouton dans ton XML
        ...
        if (currentUser != null) {
            ...
            db.collection("users").document(uid).get().addOnSuccessListener(documentSnapshot -> {
                if (documentSnapshot.exists()) {
                    ...
                    Toast.makeText(AdminProfileActivity.this, "Erreur: " + e.getMessage(), Toast.LENGTH_SHORT).show()
            );
        }
    }
                    ...
                    .addOnSuccessListener(aVoid -> {
                        currentUser.updateEmail(newEmail)
                                .addOnSuccessListener(aVoid1 ->
                                        Toast.makeText(AdminProfileActivity.this, "Infos mises à jour", Toast.LENGTH_SHORT).show()
                                )
                                .addOnFailureListener(e ->
                                        Toast.makeText(AdminProfileActivity.this, "Erreur maj email: " + e.getMessage(), Toast.LENGTH_SHORT).show()
                                );
                    })
                    .addOnFailureListener(e ->
                            Toast.makeText(AdminProfileActivity.this, "Erreur Firestore: " + e.getMessage(), Toast.LENGTH_SHORT).show()
                    );
        }
    }
    ...
    private void deleteAccount() {
        if (currentUser != null) {
            currentUser.delete().addOnSuccessListener(aVoid -> {
                Toast.makeText(AdminProfileActivity.this, "Compte supprimé", Toast.LENGTH_SHORT).show();
                goToLogin();
            }).addOnFailureListener(e ->
                    Toast.makeText(AdminProfileActivity.this, "Erreur suppression: " + e.getMessage(), Toast.LENGTH_LONG).show()
            );
        }
    }
